...
invoke(material,'Sigma','3.56e+007');
invoke(material,'Rho','2700.0');
invoke(material,'ThermalType','Normal');
invoke(material,'ThermalConductivity','237.0');
invoke(material,'HeatCapacity','0.9');
...
invoke(material,'YoungsModulus','69'); 
invoke(material,'PoissonsRatio','0.33'); 
invoke(material,'ThermalExpansionRate','23');
...
invoke(material,'Mue','1.0');
invoke(material,'Kappa','3.56e+007');
